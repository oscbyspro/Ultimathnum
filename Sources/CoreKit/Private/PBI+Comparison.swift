...
extension Namespace.ProperBinaryInteger where Base: SystemInteger {
    ...
    @inlinable package static func compare<Other: SystemInteger>(_ lhs: Base, to rhs: Other) -> Signum {
    ...
    @inlinable package static func compareIsMoreThan<Other: SystemInteger>(_ lhs: Base, to rhs: Other) -> Bool {
        PBI.compareIsLessThan(rhs, to: lhs)
    }
    
    @inlinable package static func compareIsLessThanOrEqual<Other: SystemInteger>(_ lhs: Base, to rhs: Other) -> Bool {
        PBI.compareIsMoreThan(lhs, to: rhs) == false
    }
    
    @inlinable package static func compareIsMoreThanOrEqual<Other: SystemInteger>(_ lhs: Base, to rhs: Other) -> Bool {
