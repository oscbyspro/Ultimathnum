...
//*============================================================================*
// MARK: * UMN x Strict Unsigned Integer
//*============================================================================*
...
extension UMN {
    ...
    ///
    @frozen public enum StrictUnsignedInteger<Base> where Base: RandomAccessCollection, Base.Element: UMNSystemInteger & UMNUnsignedInteger {
