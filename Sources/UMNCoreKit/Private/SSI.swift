...
//*============================================================================*
// MARK: * UMN x Strict Signed Integer
//*============================================================================*
...
extension UMN {
    ...
    ///
    @frozen public enum StrictSignedInteger<Base> where Base: RandomAccessCollection, Base.Element: UMNSystemInteger & UMNUnsignedInteger {
