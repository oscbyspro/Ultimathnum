...
extension TripleIntTests {
    ...
    func testComparison() {
        func whereTheBaseIs<B>(_ base: B.Type) where B: SystemsInteger {
            ...
            //=----------------------------------=
            Test().comparison(T(low:  0, mid:  0, high:  0), a1, -1 as Signum)
            Test().comparison(T(low:  1, mid:  0, high:  0), a1, -1 as Signum)
            Test().comparison(T(low:  2, mid:  0, high:  0), a1, -1 as Signum)
            Test().comparison(T(low:  0, mid:  1, high:  0), a1, -1 as Signum)
            Test().comparison(T(low:  1, mid:  1, high:  0), a1, -1 as Signum)
            Test().comparison(T(low:  2, mid:  1, high:  0), a1, -1 as Signum)
            Test().comparison(T(low:  0, mid:  2, high:  0), a1, -1 as Signum)
            Test().comparison(T(low:  1, mid:  2, high:  0), a1, -1 as Signum)
            Test().comparison(T(low:  2, mid:  2, high:  0), a1, -1 as Signum)
            Test().comparison(T(low:  0, mid:  0, high:  1), a1, -1 as Signum)
            Test().comparison(T(low:  1, mid:  0, high:  1), a1, -1 as Signum)
            Test().comparison(T(low:  2, mid:  0, high:  1), a1, -1 as Signum)
            Test().comparison(T(low:  0, mid:  1, high:  1), a1, -1 as Signum)
            Test().comparison(T(low:  1, mid:  1, high:  1), a1,  0 as Signum)
            Test().comparison(T(low:  2, mid:  1, high:  1), a1,  1 as Signum)
            Test().comparison(T(low:  0, mid:  2, high:  1), a1,  1 as Signum)
            Test().comparison(T(low:  1, mid:  2, high:  1), a1,  1 as Signum)
            Test().comparison(T(low:  2, mid:  2, high:  1), a1,  1 as Signum)
            Test().comparison(T(low:  0, mid:  0, high:  2), a1,  1 as Signum)
            Test().comparison(T(low:  1, mid:  0, high:  2), a1,  1 as Signum)
            Test().comparison(T(low:  2, mid:  0, high:  2), a1,  1 as Signum)
            Test().comparison(T(low:  0, mid:  1, high:  2), a1,  1 as Signum)
            Test().comparison(T(low:  1, mid:  1, high:  2), a1,  1 as Signum)
            Test().comparison(T(low:  2, mid:  1, high:  2), a1,  1 as Signum)
            Test().comparison(T(low:  0, mid:  2, high:  2), a1,  1 as Signum)
            Test().comparison(T(low:  1, mid:  2, high:  2), a1,  1 as Signum)
            Test().comparison(T(low:  2, mid:  2, high:  2), a1,  1 as Signum)
            //=----------------------------------=
            ...
            //=----------------------------------=
            Test().comparison(T(low: ~0, mid: ~0, high: ~0), b1,  1 as Signum)
            Test().comparison(T(low: ~1, mid: ~0, high: ~0), b1,  1 as Signum)
            Test().comparison(T(low: ~2, mid: ~0, high: ~0), b1,  1 as Signum)
            Test().comparison(T(low: ~0, mid: ~1, high: ~0), b1,  1 as Signum)
            Test().comparison(T(low: ~1, mid: ~1, high: ~0), b1,  1 as Signum)
            Test().comparison(T(low: ~2, mid: ~1, high: ~0), b1,  1 as Signum)
            Test().comparison(T(low: ~0, mid: ~2, high: ~0), b1,  1 as Signum)
            Test().comparison(T(low: ~1, mid: ~2, high: ~0), b1,  1 as Signum)
            Test().comparison(T(low: ~2, mid: ~2, high: ~0), b1,  1 as Signum)
            Test().comparison(T(low: ~0, mid: ~0, high: ~1), b1,  1 as Signum)
            Test().comparison(T(low: ~1, mid: ~0, high: ~1), b1,  1 as Signum)
            Test().comparison(T(low: ~2, mid: ~0, high: ~1), b1,  1 as Signum)
            Test().comparison(T(low: ~0, mid: ~1, high: ~1), b1,  1 as Signum)
            Test().comparison(T(low: ~1, mid: ~1, high: ~1), b1,  0 as Signum)
            Test().comparison(T(low: ~2, mid: ~1, high: ~1), b1, -1 as Signum)
            Test().comparison(T(low: ~0, mid: ~2, high: ~1), b1, -1 as Signum)
            Test().comparison(T(low: ~1, mid: ~2, high: ~1), b1, -1 as Signum)
            Test().comparison(T(low: ~2, mid: ~2, high: ~1), b1, -1 as Signum)
            Test().comparison(T(low: ~0, mid: ~0, high: ~2), b1, -1 as Signum)
            Test().comparison(T(low: ~1, mid: ~0, high: ~2), b1, -1 as Signum)
            Test().comparison(T(low: ~2, mid: ~0, high: ~2), b1, -1 as Signum)
            Test().comparison(T(low: ~0, mid: ~1, high: ~2), b1, -1 as Signum)
            Test().comparison(T(low: ~1, mid: ~1, high: ~2), b1, -1 as Signum)
            Test().comparison(T(low: ~2, mid: ~1, high: ~2), b1, -1 as Signum)
            Test().comparison(T(low: ~0, mid: ~2, high: ~2), b1, -1 as Signum)
            Test().comparison(T(low: ~1, mid: ~2, high: ~2), b1, -1 as Signum)
            Test().comparison(T(low: ~2, mid: ~2, high: ~2), b1, -1 as Signum)
        }
