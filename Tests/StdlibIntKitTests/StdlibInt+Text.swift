...
extension StdlibIntTests {
    ...
    func testInitText() {
        ...
        Test().success({ try T("+10", as:     .decimal) },   10)
        Test().success({ try T("-10", as:     .decimal) },  -10)
        Test().failure({ try T( "ff", as:     .decimal) },  TextInt.Failure.invalid)
        Test().failure({ try T("+ff", as:     .decimal) },  TextInt.Failure.invalid)
        Test().failure({ try T("-ff", as:     .decimal) },  TextInt.Failure.invalid)
        Test().failure({ try T( "zz", as:     .decimal) },  TextInt.Failure.invalid)
        Test().failure({ try T("+zz", as:     .decimal) },  TextInt.Failure.invalid)
        Test().failure({ try T("-zz", as:     .decimal) },  TextInt.Failure.invalid)
        ...
        Test().success({ try T("+ff", as: .hexadecimal) },  255)
        Test().success({ try T("-ff", as: .hexadecimal) }, -255)
        Test().failure({ try T( "zz", as: .hexadecimal) },  TextInt.Failure.invalid)
        Test().failure({ try T("+zz", as: .hexadecimal) },  TextInt.Failure.invalid)
        Test().failure({ try T("-zz", as: .hexadecimal) },  TextInt.Failure.invalid)
    }
