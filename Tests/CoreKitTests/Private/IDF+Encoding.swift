...
final class IntegerDescriptionFormatTestsOnEncoding: XCTestCase {
    ...
    func testInt32() {
        check(Test(), I32(truncating: 0x00000000 as U32),           "0")
        check(Test(), I32(truncating: 0x03020100 as U32),    "50462976")
        check(Test(), I32(truncating: 0x7fffffff as U32),  "2147483647") // I32.max
        check(Test(), I32(truncating: 0x80000000 as U32), "-2147483648") // I32.min
        check(Test(), I32(truncating: 0x81807f7e as U32), "-2122285186")
        check(Test(), I32(truncating: 0xfffefdfc as U32),      "-66052")
        check(Test(), I32(truncating: 0xffffffff as U32),          "-1")
    }
    
    func testUInt32() {
        check(Test(), U32(truncating: 0x00000000 as U32),           "0") // U32.min
        check(Test(), U32(truncating: 0x03020100 as U32),    "50462976")
        check(Test(), U32(truncating: 0x7fffffff as U32),  "2147483647")
        check(Test(), U32(truncating: 0x80000000 as U32),  "2147483648")
        check(Test(), U32(truncating: 0x81807f7e as U32),  "2172682110")
        check(Test(), U32(truncating: 0xfffefdfc as U32),  "4294901244")
        check(Test(), U32(truncating: 0xffffffff as U32),  "4294967295") // U32.max
    }

    func testI64() {
        check(Test(), I64(truncating: 0x0000000000000000 as U64),                    "0")
        check(Test(), I64(truncating: 0x0706050403020100 as U64),   "506097522914230528")
        check(Test(), I64(truncating: 0x7fffffffffffffff as U64),  "9223372036854775807") // I64.max
        check(Test(), I64(truncating: 0x8000000000000000 as U64), "-9223372036854775808") // I64.max
        check(Test(), I64(truncating: 0x838281807f7e7d7c as U64), "-8970465118873813636")
        check(Test(), I64(truncating: 0xfffefdfcfbfaf9f8 as U64),     "-283686952306184")
        check(Test(), I64(truncating: 0xffffffffffffffff as U64),                   "-1")
    }

    func testU64() {
        check(Test(), U64(truncating: 0x0000000000000000 as U64),                    "0") // U64.min
        check(Test(), U64(truncating: 0x0706050403020100 as U64),   "506097522914230528")
        check(Test(), U64(truncating: 0x7fffffffffffffff as U64),  "9223372036854775807")
        check(Test(), U64(truncating: 0x8000000000000000 as U64),  "9223372036854775808")
        check(Test(), U64(truncating: 0x838281807f7e7d7c as U64),  "9476278954835737980")
        check(Test(), U64(truncating: 0xfffefdfcfbfaf9f8 as U64), "18446460386757245432")
        check(Test(), U64(truncating: 0xffffffffffffffff as U64), "18446744073709551615") // U64.max
    }
